import type { ConfidenceClasses } from '../types'
...
export function confidenceClasses(score: number): ConfidenceClasses {
...
export function sourceTrustClass(trust: number): string {
