...
const socials = [
  {
    ...
    color: 'hover:text-green hover:border-green/30',
    icon: (
  ...
  },
  {
    ...
    color: 'hover:text-text hover:border-text/30',
    icon: (
      <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor">
          ...
          <div className="flex items-center gap-2">
            {socials.map((s) => (
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className={`w-10 h-10 flex items-center justify-center rounded-xl bg-surface border border-border text-text-secondary transition-all duration-300 ${s.color}`}
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={handleCopy}
              className="w-10 h-10 flex items-center justify-center rounded-xl bg-surface border border-border text-text-secondary transition-all duration-300 hover:text-accent hover:border-accent/30"
