...
function ShareButton({ href, name, icon }) {
  ...
  return (
    <motion.a
      ...
      className="w-10 h-10 flex items-center justify-center rounded-xl border text-text-secondary transition-all duration-300"
      style={{
  ...
  return (
    <motion.button
      ...
      style={{
        ...
        color: copied ? 'var(--color-green)' : undefined,
      }}
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          ...
          <div className="flex items-center gap-2">
            {socials.map((s) => (
              <ShareButton key={s.name} href={s.href} name={s.name} icon={s.icon} />
            ))}
            <CopyButton />
          </div>
        </div>
